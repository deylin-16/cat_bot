...
handler.command = /^(beso|kiss[23]?|beso[23]|abrazo|hug|hug2|abrazo2|golpe|slap|matar|kill|pat|acariciar|bailar|dance|patada|kick2|reir|laugh|triste|sad|cry|enojado|angry|saludo|wave|morder|bite|lamer|lick|dormir|sleep|comer|eat|asustar|scare|disparar|shoot|correr|run|mirar|stare|asombro|wow|tímido|blush|cafe|coffee|suicidio|suicide|aplaudir|clap|vomitar|vomit|cocinar|cook|casar|marry|divorcio|divorce|twerk|estudiar|study|trabajar|work|ejercicio|workout|bañarse|shower|espiar|stalk|volar|fly|beber|drink|beer|fútbol|soccer|baloncesto|basketball|nadar|swim|cantar|sing|tocar_guitarra|guitar|tocar_piano|piano|dibujar|draw|escribir|write|leer|read|viajar|travel|comprar|shop|limpiar|clean|conducir|drive|montar_bici|bike|teletransportarse|teleport|explotar|explode|congelar|freeze|quemar|burn|electrocutar|lightning|invocar|summon|transformarse|morph|sanar|heal|proteger|protect|caerse|fall|pescar|fish|jardinería|garden|meditar|apostar|gamble|robar|steal|mentir|lie|asustarse|fear|suplicar|beg|desprecio|disgust|orgulloso|smug|aburrido|bored|confundido|emocionado|excited|cansado|tired|beber_agua|water|comer_hamburguesa|burger|comer_dulces|candy|desayunar|cenar|dinner|comer_helado|icecream|beber_jugo|juice|comer_fruta|fruit|vapear|vape|peinarse|brush|maquillarse|makeup|vestirse|dress|mirarse_espejo|mirror|money|pc|tv|music|photo|record|skate|surf|ski|camp|pesadilla|wakeup|sneeze|sick|spank|cuddle|pillowfight|stars)$/i
handler.group = true
